...
(function (app) {
    ...
    function Controller($http, $location, $routeParams, $scope, $window, common, user, Draft, util) {
        // #region vars
        var vm = this;
        ...
        function activate() {
            ...
            if (true) {
                vm.draft = Draft.get({ Id: id }, function (d) {
                });
            } else {
                vm.draft = localDraft;
                //hub.joinGroup(vm);
        ...
        function save() {
            ...
            saved.catch(function (rejection) {
                draftDirty = true;
        ...
        function postPropertyChange(name) {
            draftDirty = true;
        }
    }
})(app || (app = {}));
